...
public class SupportTest {
	...
	protected ProductDescPage productDesc;
	protected ProductListPage productList;
	...
	public void runOncePerMethod(ITestContext context, Method method) throws Exception {
		...
		account = new AccountPage(this.conf, agent, testData);
		productDesc = new ProductDescPage(this.conf, agent, testData);
		productList = new ProductListPage(this.conf, agent, testData);
